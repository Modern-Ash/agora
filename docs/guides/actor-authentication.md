...
This authentication policy protects work transitions, approvals, handoffs, Tool Run launch, and
agent-session launch. It does not yet sign session preparation, interruption, or delegation changes, and it does
