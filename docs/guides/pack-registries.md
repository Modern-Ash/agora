...
update. Signed organization trust and revocation feeds are implemented; root rotation, threshold
trust, third-party transparency proofs, and background notifications remain future work. Local and
