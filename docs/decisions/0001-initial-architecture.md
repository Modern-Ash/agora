...
- Background registry notifications and dependency-aware pack updates. Explicit authenticated checks,
  transactional registry replacement, and durable update history are implemented.
