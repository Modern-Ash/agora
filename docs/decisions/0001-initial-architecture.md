...
- Third-party transparency-log proofs for remote registry releases. Their independent checkpoint
  authority store, distinct-key release signature thresholds, signed sequential trust and
  revocation feeds, and dual-signed organization root rotation are implemented.
