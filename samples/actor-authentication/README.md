...
The flow signs and applies work block/resume interruptions, a transition, Product Owner approval,
and a developer handoff, then signs and launches both a repository Tool Run and an agent session. Lifecycle authorization binds
