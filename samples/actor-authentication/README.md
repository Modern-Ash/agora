...
then has the current key sign a planned rotation, uses a distinct Scrum Master identity to authorize
revocation and recovery to a third key, and proves the completed work remains valid.
