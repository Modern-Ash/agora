...
class AgoraWorkspace:
    ...
    def _render_session_context(
        ...
        return (
            ...
            "5a. Pause and ask the human one concrete question — a line of context, the choice, "
            "and a recommended default — before any material decision, human-only approval, gate "
            "transition, or unapproved external, destructive, or costly action. When nothing "
            "needs a decision or confirmation, act without asking.\n"
            "5b. End the turn once the requested step is done or the next move is not yours to "
            "make. Do not continue into unrelated checks, and do not restate what was already "
            "reported. Silence is fine when there is nothing to confirm or decide.\n"
