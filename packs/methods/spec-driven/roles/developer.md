...
allowed-actions: ["actor.key.rotate", "actor.runtime.update", "criterion.satisfy", "work.transition", "work.block", "work.resume", "work.verify-consistency", "work.gherkin", "work.delegate", "delegation.collect", "artifact.add", "evidence.add", "checklist.add", "checklist.check", "usage.add", "handoff.create"]
